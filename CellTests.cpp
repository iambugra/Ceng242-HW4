...
//    cout << "out1 - " <<cell->GetCellWall().size() <<endl;
//    cout << "out2 - " << cellCircle->GetCellWall().size()<<endl;
//    cout << "out3 - " <<cellT1->GetCellWall().size() << endl;
//    cout << "out4 - " <<cellT2->GetCellWall().size() <<endl;
//    cout << "out5 - " <<unknownCell->GetCellWall().size() <<endl;
